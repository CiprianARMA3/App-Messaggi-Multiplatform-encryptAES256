    ...
    <main className="relative z-10 flex-1 flex flex-col items-center justify-center text-center px-6 mt-20">
      <div className="py-8 sm:py-6">
        ...
        <div className="flex flex-wrap gap-6 justify-center mt-16 ">
                    <div className="relative w-80 p-6 rounded-2xl bg-white/0 backdrop-blur-3xl border border-white/20 shadow-lg overflow-hidden transition-transform-shadow duration-500 ease-in-out hover:scale-y-100 hover:translate-y-[-13px]   hover:shadow-[0_0_15px_rgba(255,255,255,0.8)]">
        ...
        <div className="h-px w-full bg-gradient-to-r from-transparent via-white/40 to-transparent mt-5"></div>
    </main>
  );
}
